    ...
    <div class="content-grid">
        ...
        <div class="contentbox patienets-info">
            ...
            <div id="informacion" class="tab-content active">
                <form id="formulario-empleado">
                    ...
                    <div class="button-group">
                        ...
                        <button type="reset" id="descartar-btn" class="delete-button" style="display: none;"
                            onclick="deshabilitarEdicionEmpleado()">Descartar cambios</button>
                ...
                <button type="button" class="delete-button" onclick="confirmarEliminacion(<?php echo $empleadoData['idEmpleado'] ?? 'null'; ?>)">Eliminar empleado</button>
            </div>
